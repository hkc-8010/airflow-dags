...
'email': ['ranjith_pulluri@bnz.co.nz'],
...
dag = DAG(
'FCH_S3Key_CustomSensor',
default_args=default_args,
description='Informatica BDM DAG WITH PARAMFL ON AIRFLOW SERVER',
...
Get_Dates = ProcessingDateOperator(
    task_id='get_dates',
    schedule="CALENDAR_DAILY",
    current_processing_date="{{ ds_nodash }}",
    previous_processing_date="{{ prev_ds_nodash }}",
    dag=dag,
)
...
wildcard_match = True,
bucket_name= 'bdh-nonprod-informatica-binaries',
soft_fail = False,
poke_interval = 60,
timeout = 300,
mode = "reschedule",
...
print_date_bdmlog >> Get_Dates >> dyn_bucket_key >> bashop_test
