...
with cte_header as (
    ...
    , left('obh015' || repeat(' ', 8), 8) as program_name                       -- input
    , left('Employee Assessment Rating File' || repeat(' ', 40), 40) as file_description      -- input
    , '+' as sign1
    ...
    , '000000001' as file_identifier_code
    , '+' as sign2
    , left('0' || repeat('0', 9), 9)  as record_count
